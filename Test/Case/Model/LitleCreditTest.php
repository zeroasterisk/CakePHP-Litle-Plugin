...
class LitleCreditTest extends CakeTestCase {
	public $plugin = 'app';
	...
	*/
	public function startTest($method) {
		...
		$this->reconfigure();
		$this->LitleCredit = ClassRegistry::init('Litle.LitleCredit');
	...
	*/
	public function testSetup() {
		$this->assertTrue(is_object($this->LitleCredit));
		$this->assertEqual($this->LitleCredit->alias, 'LitleCredit');
		$this->assertTrue(empty($this->LitleCredit->useTable));
